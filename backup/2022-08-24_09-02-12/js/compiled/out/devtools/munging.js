...
var o26372 = temp__5733__auto__;
var temp__5733__auto____$1 = (o26372["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o26373 = temp__5733__auto____$1;
return (o26373["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__25484__auto___26376 = t;
(o__25484__auto___26376["cljs$lang$ctorPrWriter"]).call(o__25484__auto___26376,t,writer);
}catch (e26375){var __26377 = e26375;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26378 = num_code;
switch (G__26378) {
case (1):
return (185);
...
}catch (e26380){var _e__25491__auto__ = e26380;
return false;
}})())){
...
var vec__26381 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26381,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o26384 = temp__5733__auto__;
var temp__5733__auto____$1 = (o26384["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o26385 = temp__5733__auto____$1;
return (o26385["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26388){
var vec__26389 = p__26388;
var ns_detector = cljs.core.nth.call(null,vec__26389,(0),null);
...
var G__26395 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26396 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26395;
remaining_tokens = G__26396;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26386){
...
var vec__26400 = cljs.core.split_with.call(null,(function (p1__26399_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26399_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26400,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26400,(1),null);
...
var vec__26406 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26406,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26406,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26409 = cljs.core.rest.call(null,remaining_tokens);
var G__26410 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26409;
name_tokens = G__26410;
continue;
} else {
...
var vec__26413 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26413,(0),null);
var arity = cljs.core.nth.call(null,vec__26413,(1),null);
var vec__26416 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26416,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26416,(1),null);
var vec__26419 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26419,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26419,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26419,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26419,(3),null);
...
var vec__26425 = result;
var munged_ns = cljs.core.nth.call(null,vec__26425,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26425,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26425,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26425,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26425,(4),null);
var arity = cljs.core.nth.call(null,vec__26425,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__26429 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__26429,(0),null);
var args = cljs.core.nth.call(null,vec__26429,(1),null);
var vec__26432 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26432,(0),null);
var name = cljs.core.nth.call(null,vec__26432,(1),null);
...
var G__26435 = (arity + (1));
var G__26436 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26437){
var vec__26438 = p__26437;
var arity = cljs.core.nth.call(null,vec__26438,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26438,(1),null);
...
return cljs.core.get.call(null,arities,p1__26441_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__26442_SHARP_){
return cljs.core.drop.call(null,(2),p1__26442_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___26449 = arguments.length;
var i__4731__auto___26450 = (0);
while(true){
if((i__4731__auto___26450 < len__4730__auto___26449)){
args__4736__auto__.push((arguments[i__4731__auto___26450]));

var G__26451 = (i__4731__auto___26450 + (1));
i__4731__auto___26450 = G__26451;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26445){
var vec__26446 = p__26445;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26446,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26443){
var G__26444 = cljs.core.first.call(null,seq26443);
var seq26443__$1 = cljs.core.next.call(null,seq26443);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26444,seq26443__$1);
});
...
var map__26454 = options;
var map__26454__$1 = (((((!((map__26454 == null))))?(((((map__26454.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26454.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26454):map__26454);
var include_ns_QMARK_ = cljs.core.get.call(null,map__26454__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26454__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26454__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26454__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26455 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26455,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26455,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26455,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26455,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26455,(4),null);
var arity = cljs.core.nth.call(null,vec__26455,(5),null);
...
}catch (e26459){var _e__25491__auto__ = e26459;
...
var G__26460 = (obj[cljs.core.first.call(null,path)]);
var G__26461 = cljs.core.rest.call(null,path);
obj = G__26460;
path = G__26461;
continue;
} else {
...
return (function (accum,p__26462){
var vec__26463 = p__26462;
var bit = cljs.core.nth.call(null,vec__26463,(0),null);
var protocol = cljs.core.nth.call(null,vec__26463,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26466){
var vec__26467 = p__26466;
var ns = cljs.core.nth.call(null,vec__26467,(0),null);
var name = cljs.core.nth.call(null,vec__26467,(1),null);
var selector = cljs.core.nth.call(null,vec__26467,(2),null);
...
return (function (p__26471){
var vec__26472 = p__26471;
var munged_name = cljs.core.nth.call(null,vec__26472,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26472,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26472,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26470_SHARP_){
return (obj[cljs.core.first.call(null,p1__26470_SHARP_)]);
});})(name,sorted_matches,vec__26472,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1560468647837
