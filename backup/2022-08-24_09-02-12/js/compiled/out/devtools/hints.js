...
var line = cljs.core.get.call(null,map__28588__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__28588__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e28587){var _e = e28587;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___28590 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___28590)){
var seen_errors_28591 = temp__5733__auto___28590;
if(cljs.core.truth_(seen_errors_28591.has(self))){
} else {
seen_errors_28591.add(self);

var temp__5735__auto___28592 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___28592)){
var sense_28593 = temp__5735__auto___28592;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28593)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1560468651204
