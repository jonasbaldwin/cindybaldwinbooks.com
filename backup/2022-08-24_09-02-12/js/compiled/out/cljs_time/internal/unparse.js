...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__24945 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__24945){
return (function (p1__24944_SHARP_){
return cljs.core.subs.call(null,p1__24944_SHARP_,(0),(3));
});})(G__24945))
,G__24945);
} else {
return G__24945;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__24954){
var vec__24955 = p__24954;
var t = cljs.core.nth.call(null,vec__24955,(0),null);
var pattern = cljs.core.nth.call(null,vec__24955,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__24958 = pattern;
switch (G__24958) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24958)].join('')));
...
switch (G__24968__$1) {
case "millis":
return ((function (G__24968,G__24968__$1){
return (function (p1__24960_SHARP_){
return p1__24960_SHARP_.getMilliseconds();
});
;})(G__24968,G__24968__$1))

break;
case "seconds":
return ((function (G__24968,G__24968__$1){
return (function (p1__24961_SHARP_){
return p1__24961_SHARP_.getSeconds();
});
;})(G__24968,G__24968__$1))
...
return p1__24962_SHARP_.getMinutes();
});
;})(G__24968,G__24968__$1))
...
return p1__24963_SHARP_.getHours();
});
;})(G__24968,G__24968__$1))
...
return p1__24964_SHARP_.getHours();
});
;})(G__24968,G__24968__$1))
...
return p1__24965_SHARP_.getDate();
});
;})(G__24968,G__24968__$1))
...
return p1__24966_SHARP_.getMonth();
});
;})(G__24968,G__24968__$1))
...
return p1__24967_SHARP_.getYear();
});
;})(G__24968,G__24968__$1))

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24968__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__24970){
var vec__24971 = p__24970;
var seq__24972 = cljs.core.seq.call(null,vec__24971);
var first__24973 = cljs.core.first.call(null,seq__24972);
var seq__24972__$1 = cljs.core.next.call(null,seq__24972);
var key = first__24973;
var args = seq__24972__$1;
var G__24974 = key;
...
break;
case "ordinal-suffix":
var vec__24975 = syntax_list.call(null,(i - (1)));
...
var d = value;
var G__24982 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__24983 = G__24982;
var seq__24984 = cljs.core.seq.call(null,vec__24983);
var first__24985 = cljs.core.first.call(null,seq__24984);
var seq__24984__$1 = cljs.core.next.call(null,seq__24984);
var unparser = first__24985;
var more = seq__24984__$1;
var s = "";
var d__$1 = d;
var G__24982__$1 = G__24982;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__24992 = G__24982__$1;
...
var unparser__$1 = first__24994;
var more__$1 = seq__24993__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__24995 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__24995,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__24995,(1),null);
var G__24998 = d__$3;
var G__24999 = more__$1;
var G__25000 = s__$3;
d__$1 = G__24998;
G__24982__$1 = G__24999;
s__$1 = G__25000;
continue;
}
break;
...
//# sourceMappingURL=unparse.js.map?rel=1560468646288
