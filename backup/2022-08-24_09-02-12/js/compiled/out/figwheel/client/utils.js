...
return (new CustomEvent(event_name,(function (){var obj31921 = ({"detail":data});
return obj31921;
})()));
} else {
...
var f = (function (){var pred__31928 = cljs.core._EQ_;
var expr__31929 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31928.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31929))){
return ((function (pred__31928,expr__31929){
return (function (p1__31922_SHARP_){
return console.warn(p1__31922_SHARP_);
});
;})(pred__31928,expr__31929))
} else {
if(cljs.core.truth_(pred__31928.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31929))){
return ((function (pred__31928,expr__31929){
return (function (p1__31923_SHARP_){
return console.debug(p1__31923_SHARP_);
});
;})(pred__31928,expr__31929))
} else {
if(cljs.core.truth_(pred__31928.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31929))){
return ((function (pred__31928,expr__31929){
return (function (p1__31924_SHARP_){
return console.error(p1__31924_SHARP_);
});
;})(pred__31928,expr__31929))
} else {
return ((function (pred__31928,expr__31929){
return (function (p1__31925_SHARP_){
return console.log(p1__31925_SHARP_);
});
;})(pred__31928,expr__31929))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31932){
var map__31933 = p__31932;
var map__31933__$1 = (((((!((map__31933 == null))))?(((((map__31933.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31933.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31933):map__31933);
var opts = map__31933__$1;
var eval_fn = cljs.core.get.call(null,map__31933__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31935_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31937,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1560468653648
