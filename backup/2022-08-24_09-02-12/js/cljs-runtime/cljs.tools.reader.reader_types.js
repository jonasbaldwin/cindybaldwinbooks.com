...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44597 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44597(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44603 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44603(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44607 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44607(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44615 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44615(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44621 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44621(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44628 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44628(reader);
}
});
