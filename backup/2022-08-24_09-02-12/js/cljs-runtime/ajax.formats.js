...
var G__53934 = request;
var G__53935 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__53934,G__53935) : ajax.formats.get_format.call(null,G__53934,G__53935));
} else {
...
return cljs.core.some((function (p1__53937_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__53937_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__53939){
var map__53941 = p__53939;
var map__53941__$1 = cljs.core.__destructure_map(map__53941);
var request = map__53941__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53941__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__53946 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__53946.cljs$core$IFn$_invoke$arity$1 ? fexpr__53946.cljs$core$IFn$_invoke$arity$1(response) : fexpr__53946.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__53948){
var map__53949 = p__53948;
var map__53949__$1 = cljs.core.__destructure_map(map__53949);
var request = map__53949__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53949__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__53947_SHARP_){
return ajax.formats.get_accept_entries(request,p1__53947_SHARP_);
