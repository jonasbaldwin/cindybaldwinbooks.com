...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_52078 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_52078(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_52079 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_52079(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_52080 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_52080(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_52081 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_52081(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_52082 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_52082(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_52083 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_52083(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_52086 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_52086(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_52087 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_52087(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_52090 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_52090(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_52092 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_52092(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k52027,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__52040 = k52027;
var G__52040__$1 = (((G__52040 instanceof cljs.core.Keyword))?G__52040.fqn:null);
switch (G__52040__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k52027,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__52042){
var vec__52043 = p__52042;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52043,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52043,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__52026){
var self__ = this;
var G__52026__$1 = this;
return (new cljs.core.RecordIter((0),G__52026__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this52028,other52029){
var self__ = this;
var this52028__$1 = this;
return (((!((other52029 == null)))) && ((((this52028__$1.constructor === other52029.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52028__$1.status,other52029.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52028__$1.body,other52029.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52028__$1.status_text,other52029.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52028__$1.headers,other52029.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52028__$1.was_aborted,other52029.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this52028__$1.__extmap,other52029.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k52027){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k52027);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__52026){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__52070 = cljs.core.keyword_identical_QMARK_;
var expr__52071 = k__4511__auto__;
if(cljs.core.truth_((pred__52070.cljs$core$IFn$_invoke$arity$2 ? pred__52070.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__52071) : pred__52070.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__52071)))){
return (new ajax.protocols.Response(G__52026,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52070.cljs$core$IFn$_invoke$arity$2 ? pred__52070.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__52071) : pred__52070.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__52071)))){
return (new ajax.protocols.Response(self__.status,G__52026,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52070.cljs$core$IFn$_invoke$arity$2 ? pred__52070.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__52071) : pred__52070.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__52071)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__52026,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52070.cljs$core$IFn$_invoke$arity$2 ? pred__52070.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__52071) : pred__52070.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__52071)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__52026,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__52070.cljs$core$IFn$_invoke$arity$2 ? pred__52070.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__52071) : pred__52070.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__52071)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__52026,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__52026),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__52026){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__52026,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__52033){
var extmap__4542__auto__ = (function (){var G__52077 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__52033,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__52033)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__52077);
} else {
return G__52077;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__52033),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__52033),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__52033),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__52033),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__52033),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
