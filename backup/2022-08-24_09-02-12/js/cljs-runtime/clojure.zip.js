...
var G__54274 = clojure.zip.node(loc);
var fexpr__54273 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__54273.cljs$core$IFn$_invoke$arity$1 ? fexpr__54273.cljs$core$IFn$_invoke$arity$1(G__54274) : fexpr__54273.call(null,G__54274));
});
/**
...
var G__54279 = clojure.zip.node(loc);
var fexpr__54278 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__54278.cljs$core$IFn$_invoke$arity$1 ? fexpr__54278.cljs$core$IFn$_invoke$arity$1(G__54279) : fexpr__54278.call(null,G__54279));
} else {
...
var fexpr__54281 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__54281.cljs$core$IFn$_invoke$arity$2 ? fexpr__54281.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__54281.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__54298 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54298,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54298,(1),null);
var vec__54301 = clojure.zip.children(loc);
...
var vec__54306 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54306,(0),null);
var map__54309 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54306,(1),null);
var map__54309__$1 = cljs.core.__destructure_map(map__54309);
var path = map__54309__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__54319 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54319,(0),null);
var map__54322 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54319,(1),null);
var map__54322__$1 = cljs.core.__destructure_map(map__54322);
var path = map__54322__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54322__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__54323 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54322__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__54324 = cljs.core.seq(vec__54323);
var first__54325 = cljs.core.first(seq__54324);
var seq__54324__$1 = cljs.core.next(seq__54324);
var r = first__54325;
var rnext = seq__54324__$1;
var rs = vec__54323;
...
var vec__54331 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54331,(0),null);
var map__54334 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54331,(1),null);
var map__54334__$1 = cljs.core.__destructure_map(map__54334);
var path = map__54334__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54334__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54334__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return r;
} else {
...
var vec__54338 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54338,(0),null);
var map__54341 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54338,(1),null);
var map__54341__$1 = cljs.core.__destructure_map(map__54341);
var path = map__54341__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54341__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54341__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
...
var vec__54344 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54344,(0),null);
var map__54347 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54344,(1),null);
var map__54347__$1 = cljs.core.__destructure_map(map__54347);
var path = map__54347__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54347__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54347__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__54353 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54353,(0),null);
var map__54356 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54353,(1),null);
var map__54356__$1 = cljs.core.__destructure_map(map__54356);
var path = map__54356__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54356__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__54360 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54360,(0),null);
var map__54363 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54360,(1),null);
var map__54363__$1 = cljs.core.__destructure_map(map__54363);
var path = map__54363__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54363__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54366,(1),null);
...
var len__4864__auto___54451 = arguments.length;
var i__4865__auto___54452 = (0);
while(true){
if((i__4865__auto___54452 < len__4864__auto___54451)){
args__4870__auto__.push((arguments[i__4865__auto___54452]));

var G__54456 = (i__4865__auto___54452 + (1));
i__4865__auto___54452 = G__54456;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq54370){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54371,G__54372,seq54370__$2);
}));
...
var G__54467 = clojure.zip.rightmost(child);
loc__$1 = G__54467;
continue;
} else {
return loc__$1;
...
var vec__54386 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54386,(0),null);
var map__54389 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54386,(1),null);
var map__54389__$1 = cljs.core.__destructure_map(map__54389);
var path = map__54389__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54389__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54389__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54389__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54389__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__54485 = clojure.zip.rightmost(child);
loc__$1 = G__54485;
continue;
} else {
return loc__$1;
