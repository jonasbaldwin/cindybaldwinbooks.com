...
var len__4864__auto___54505 = arguments.length;
var i__4865__auto___54506 = (0);
while(true){
if((i__4865__auto___54506 < len__4864__auto___54505)){
args__4870__auto__.push((arguments[i__4865__auto___54506]));

var G__54508 = (i__4865__auto___54506 + (1));
i__4865__auto___54506 = G__54508;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq54385){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54385));
}));
...
var G__54510 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5751__auto__){
return (function (s,r){
return clojure.string.replace(s,cljs.core.re_pattern(r),((function (text,state,matches,temp__5751__auto__){
return (function (p1__54391_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__54391_SHARP_,p1__54391_SHARP_);
});})(text,state,matches,temp__5751__auto__))
);
});})(text,state,matches,temp__5751__auto__))
,text,matches);
var G__54511 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5751__auto__){
return (function (p1__54392_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__54392_SHARP_,matches);
});})(text,state,matches,temp__5751__auto__))
);
text = G__54510;
state = G__54511;
...
var vec__54436 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__54440 = (function (){var G__54443 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__54444 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__54443,G__54444) : transformer.call(null,G__54443,G__54444));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54440,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54440,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54436,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54436,(1),null);
var G__54530 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__54531 = cljs.core.PersistentVector.EMPTY;
var G__54532 = cljs.core.rest(tokens);
var G__54533 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__54530;
buf = G__54531;
tokens = G__54532;
cur_state = G__54533;
...
var G__54535 = out;
var G__54536 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__54537 = cljs.core.rest(tokens);
var G__54538 = cur_state;
out = G__54535;
buf = G__54536;
tokens = G__54537;
cur_state = G__54538;
...
var G__54539 = out;
var G__54540 = buf;
var G__54541 = cljs.core.rest(tokens);
var G__54542 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__54539;
buf = G__54540;
tokens = G__54541;
cur_state = G__54542;
...
var G__54543 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__54544 = buf;
var G__54545 = cljs.core.rest(tokens);
var G__54546 = cur_state;
out = G__54543;
buf = G__54544;
tokens = G__54545;
cur_state = G__54546;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__54475_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__54475_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__54476_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__54476_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__54476_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
