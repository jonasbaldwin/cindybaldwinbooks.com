...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__51714_SHARP_){
return (((p1__51714_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__51714_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__51719,new cljs.core.Keyword(null,"class","class",-2030961996),daiquiri.normalize.normalize_class);
} else {
return G__51719;
}
});
...
var len__4864__auto___51777 = arguments.length;
var i__4865__auto___51778 = (0);
while(true){
if((i__4865__auto___51778 < len__4864__auto___51777)){
args__4870__auto__.push((arguments[i__4865__auto___51778]));

var G__51779 = (i__4865__auto___51778 + (1));
i__4865__auto___51778 = G__51779;
continue;
} else {
}
break;
...
/** @this {Function} */
(daiquiri.normalize.merge_with_class.cljs$lang$applyTo = (function (seq51720){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq51720));
}));
...
var vec__51735 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():((cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null),cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51735,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51735,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,daiquiri.normalize.strip_css(cljs.core.some((function (p1__51727_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__51727_SHARP_))){
return p1__51727_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1((function (p1__51728_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__51728_SHARP_))){
return daiquiri.normalize.strip_css(p1__51728_SHARP_);
} else {
return null;
}
})),names)], null);
 ...
 */
daiquiri.normalize.element = (function daiquiri$normalize$element(p__51751){
...
var tag = first__51754;
var content = seq__51753__$1;
...
var vec__51759 = daiquiri.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51759,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51759,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51759,(2),null);
var tag_attrs = (function (){var G__51762 = cljs.core.PersistentArrayMap.EMPTY;
var G__51762__$1 = (((!(cljs.core.empty_QMARK_(id))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51762,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51762);
if((!(cljs.core.empty_QMARK_(class$)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51762__$1,new cljs.core.Keyword(null,"class","class",-2030961996),class$);
} else {
return G__51762__$1;
}
})();
