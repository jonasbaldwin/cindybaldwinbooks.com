...
var hickory$core$HiccupRepresentable$as_hiccup$dyn_54555 = (function (this$){
...
return hickory$core$HiccupRepresentable$as_hiccup$dyn_54555(this$);
}
});
...
var hickory$core$HickoryRepresentable$as_hickory$dyn_54557 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return hickory$core$HickoryRepresentable$as_hickory$dyn_54557(this$);
}
});
...
var pred__54500 = cljs.core._EQ_;
var expr__54501 = (this$["nodeType"]);
if(cljs.core.truth_((pred__54500.cljs$core$IFn$_invoke$arity$2 ? pred__54500.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__54501) : pred__54500.call(null,hickory.core.Attribute,expr__54501)))){
...
if(cljs.core.truth_((pred__54500.cljs$core$IFn$_invoke$arity$2 ? pred__54500.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__54501) : pred__54500.call(null,hickory.core.Comment,expr__54501)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__54500.cljs$core$IFn$_invoke$arity$2 ? pred__54500.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__54501) : pred__54500.call(null,hickory.core.Document,expr__54501)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"]));
} else {
if(cljs.core.truth_((pred__54500.cljs$core$IFn$_invoke$arity$2 ? pred__54500.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__54501) : pred__54500.call(null,hickory.core.DocumentType,expr__54501)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__54500.cljs$core$IFn$_invoke$arity$2 ? pred__54500.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__54501) : pred__54500.call(null,hickory.core.Element,expr__54501)))){
var tag = hickory.utils.lower_case_keyword((this$["tagName"]));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["attributes"])))], null),(cljs.core.truth_((hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(tag) : hickory.utils.unescapable_content.call(null,tag)))?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54497_SHARP_){
return (p1__54497_SHARP_["wholeText"]);
}),(this$["childNodes"])):cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"])))));
} else {
if(cljs.core.truth_((pred__54500.cljs$core$IFn$_invoke$arity$2 ? pred__54500.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__54501) : pred__54500.call(null,hickory.core.Text,expr__54501)))){
return hickory.utils.html_escape((this$["wholeText"]));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__54501)].join('')));
}
}
}
}
...
var pred__54515 = cljs.core._EQ_;
var expr__54516 = (this$["nodeType"]);
if(cljs.core.truth_((pred__54515.cljs$core$IFn$_invoke$arity$2 ? pred__54515.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__54516) : pred__54515.call(null,hickory.core.Attribute,expr__54516)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__54515.cljs$core$IFn$_invoke$arity$2 ? pred__54515.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__54516) : pred__54515.call(null,hickory.core.Comment,expr__54516)))){
...
if(cljs.core.truth_((pred__54515.cljs$core$IFn$_invoke$arity$2 ? pred__54515.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__54516) : pred__54515.call(null,hickory.core.Document,expr__54516)))){
...
if(cljs.core.truth_((pred__54515.cljs$core$IFn$_invoke$arity$2 ? pred__54515.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__54516) : pred__54515.call(null,hickory.core.DocumentType,expr__54516)))){
...
if(cljs.core.truth_((pred__54515.cljs$core$IFn$_invoke$arity$2 ? pred__54515.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__54516) : pred__54515.call(null,hickory.core.Element,expr__54516)))){
...
if(cljs.core.truth_((pred__54515.cljs$core$IFn$_invoke$arity$2 ? pred__54515.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__54516) : pred__54515.call(null,hickory.core.Text,expr__54516)))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__54516)].join('')));
}
}
}
}
...
var temp__5753__auto___54596 = cljs.core.first((doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5753__auto___54596)){
var title_el_54598 = temp__5753__auto___54596;
if(cljs.core.empty_QMARK_((title_el_54598["text"]))){
hickory.core.remove_el(title_el_54598);
} else {
}
} else {
}
