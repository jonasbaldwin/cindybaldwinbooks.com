...
var o41371 = temp__5751__auto__;
var temp__5751__auto____$1 = (o41371["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o41372 = temp__5751__auto____$1;
return (o41372["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40929__auto__ = f;
return (o__40929__auto__["toString"]).call(o__40929__auto__);
} else {
return "";
}
}catch (e41387){var _ = e41387;
return "";
}});
...
try{var o__40929__auto___41750 = t;
(o__40929__auto___41750["cljs$lang$ctorPrWriter"]).call(o__40929__auto___41750,t,writer);
}catch (e41411){var __41751 = e41411;
}
...
var char_code = (function (){var o__40929__auto__ = (new String(char$));
return (o__40929__auto__["charCodeAt"]).call(o__40929__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40929__auto__ = String;
return (o__40929__auto__["fromCharCode"]).call(o__40929__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41415 = num_code;
switch (G__41415) {
case (1):
return (185);
...
var o__40929__auto__ = String;
return (o__40929__auto__["fromCharCode"]).call(o__40929__auto__,superscript_code);
});
/**
...
}catch (e41423){var _e__40937__auto__ = e41423;
return false;
}})())){
...
var vec__41425 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41425,(0),null);
...
var len__4864__auto___41787 = arguments.length;
var i__4865__auto___41788 = (0);
while(true){
if((i__4865__auto___41788 < len__4864__auto___41787)){
args__4870__auto__.push((arguments[i__4865__auto___41788]));

var G__41790 = (i__4865__auto___41788 + (1));
i__4865__auto___41788 = G__41790;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41437){
var vec__41438 = p__41437;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41438,(0),null);
...
var G__41796 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41797 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41796;
remaining_tokens = G__41797;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41435){
var G__41436 = cljs.core.first(seq41435);
var seq41435__$1 = cljs.core.next(seq41435);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41436,seq41435__$1);
}));
...
var vec__41447 = cljs.core.split_with((function (p1__41446_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41446_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41447,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41447,(1),null);
...
var vec__41459 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41459,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41459,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41812 = cljs.core.rest(remaining_tokens);
var G__41813 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41812;
name_tokens = G__41813;
continue;
} else {
...
var vec__41469 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41469,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41469,(1),null);
var vec__41472 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41472,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41472,(1),null);
var vec__41475 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41475,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41475,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41475,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41475,(3),null);
...
var vec__41487 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41487,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41487,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41487,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41487,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41487,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41487,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__41490 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41490,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41490,(1),null);
var vec__41494 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41494,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41494,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41546 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41546) : devtools.munging.parse_fn_info_deep.call(null,G__41546));
})()));
}
} else {
return fn_info;
...
var G__41868 = (arity + (1));
var G__41869 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41602){
var vec__41603 = p__41602;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41603,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41603,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41606_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41606_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41607_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41607_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41610){
var vec__41611 = p__41610;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41611,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41608){
var G__41609 = cljs.core.first(seq41608);
var seq41608__$1 = cljs.core.next(seq41608);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41609,seq41608__$1);
}));
...
var map__41624 = options;
var map__41624__$1 = cljs.core.__destructure_map(map__41624);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41624__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41624__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41624__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41624__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41625 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41625,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41625,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41625,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41625,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41625,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41625,(5),null);
...
var o__40929__auto__ = f;
return (o__40929__auto__["getBasis"]).call(o__40929__auto__);
});
/**
...
}catch (e41644){var _e__40937__auto__ = e41644;
...
var G__41931 = (obj[cljs.core.first(path)]);
var G__41932 = cljs.core.rest(path);
obj = G__41931;
path = G__41932;
continue;
} else {
...
var _STAR_ = (function (accum,p__41680){
var vec__41681 = p__41680;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41681,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41681,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41699){
var vec__41700 = p__41699;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41700,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41700,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41700,(2),null);
...
var post_process = (function (p__41720){
var vec__41722 = p__41720;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41722,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41722,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41712_SHARP_){
return (obj[cljs.core.first(p1__41712_SHARP_)]);
}),sorted_matches);
