...
var i_46742 = (0);
while(true){
if((i_46742 < arr.length)){
(arr[i_46742] = null);

var G__46743 = (i_46742 + (1));
i_46742 = G__46743;
continue;
} else {
}
...
var i_46750 = (self__.level + (1));
while(true){
if((i_46750 <= (new_level + (1)))){
(update[i_46750] = self__.header);

var G__46751 = (i_46750 + (1));
i_46750 = G__46751;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_46752 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_46752[i]));
} else {
x__$2.forward.push((((i < links_46752.length))?(links_46752[i]):null));
}

if((i < links_46752.length)){
(links_46752[i] = x__$2);
} else {
links_46752.push(x__$2);
}
...
var i_46754 = (0);
while(true){
if((i_46754 <= self__.level)){
var links_46755 = (update[i_46754]).forward;
if((x__$1 === (((i_46754 < links_46755.length))?(links_46755[i_46754]):null))){
(links_46755[i_46754] = (x__$1.forward[i_46754]));

var G__46756 = (i_46754 + (1));
i_46754 = G__46756;
continue;
} else {
var G__46757 = (i_46754 + (1));
i_46754 = G__46757;
continue;
}
} else {
...
var G__46759 = nx;
var G__46760 = (level__$1 - (1));
x = G__46759;
level__$1 = G__46760;
continue;
} else {
var G__46761 = x;
var G__46762 = (level__$1 - (1));
x = G__46761;
level__$1 = G__46762;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__46764 = nx;
var G__46765 = (level__$1 - (1));
x = G__46764;
level__$1 = G__46765;
continue;
} else {
var G__46766 = x;
var G__46767 = (level__$1 - (1));
x = G__46766;
level__$1 = G__46767;
continue;
}
