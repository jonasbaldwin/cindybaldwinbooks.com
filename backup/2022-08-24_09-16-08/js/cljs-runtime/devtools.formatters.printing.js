...
var len__4864__auto___42799 = arguments.length;
var i__4865__auto___42801 = (0);
while(true){
if((i__4865__auto___42801 < len__4864__auto___42799)){
args__4870__auto__.push((arguments[i__4865__auto___42801]));

var G__42802 = (i__4865__auto___42801 + (1));
i__4865__auto___42801 = G__42802;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42670){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42671,G__42672,seq42670__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42731_SHARP_){
return (!((cljs.core.meta(p1__42731_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42760__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42763){var _e__40937__auto__ = e42763;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e42768){var _e__40937__auto__ = e42768;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42785 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42786 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42786);

try{devtools.formatters.state.add_object_to_current_path_info_BANG_(obj);

var map__42788 = opts;
var map__42788__$1 = cljs.core.__destructure_map(map__42788);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42788__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42785);
}});
...
var temp__5751__auto___42832 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42832)){
var managed_print_level_42833 = temp__5751__auto___42832;
var _STAR_print_level_STAR__orig_val__42790_42836 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42791_42837 = managed_print_level_42833;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42791_42837);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42789_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42789_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42790_42836);
}} else {
job_fn();
}
