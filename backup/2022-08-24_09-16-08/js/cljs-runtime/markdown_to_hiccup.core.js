...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("markdown-to-hiccup.core","options","markdown-to-hiccup.core/options",439665020),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("markdown-to-hiccup.core","encode?","markdown-to-hiccup.core/encode?",-1516433262)], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("markdown-to-hiccup.core","encode?","markdown-to-hiccup.core/encode?",-1516433262)], null),null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__55147){
return cljs.core.map_QMARK_(G__55147);
})], null),(function (G__55147){
return cljs.core.map_QMARK_(G__55147);
...
var len__4864__auto___55239 = arguments.length;
var i__4865__auto___55240 = (0);
while(true){
if((i__4865__auto___55240 < len__4864__auto___55239)){
args__4870__auto__.push((arguments[i__4865__auto___55240]));

var G__55241 = (i__4865__auto___55240 + (1));
i__4865__auto___55240 = G__55241;
continue;
} else {
}
break;
...
var G__55243 = cljs.core.rest(hiccup);
var G__55244 = kws;
hiccup = G__55243;
kws = G__55244;
continue;
...
var G__55245 = cljs.core.rest(hiccup);
var G__55246 = kws;
hiccup = G__55245;
kws = G__55246;
continue;
...
var G__55247 = hiccup;
var G__55248 = cljs.core.rest(kws);
hiccup = G__55247;
kws = G__55248;
continue;
} else {
var G__55249 = cljs.core.rest(hiccup);
var G__55250 = kws;
hiccup = G__55249;
kws = G__55250;
continue;
...
/** @this {Function} */
(markdown_to_hiccup.core.hicc_in.cljs$lang$applyTo = (function (seq55221){
var G__55222 = cljs.core.first(seq55221);
var seq55221__$1 = cljs.core.next(seq55221);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55222,seq55221__$1);
}));

markdown_to_hiccup.core.keywords_QMARK_ = (function markdown_to_hiccup$core$keywords_QMARK_(var_args){
var args__4870__auto__ = [];
var len__4864__auto___55251 = arguments.length;
var i__4865__auto___55252 = (0);
while(true){
if((i__4865__auto___55252 < len__4864__auto___55251)){
args__4870__auto__.push((arguments[i__4865__auto___55252]));

var G__55253 = (i__4865__auto___55252 + (1));
i__4865__auto___55252 = G__55253;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown_to_hiccup.core.keywords_QMARK_.cljs$lang$applyTo = (function (seq55223){
...
var vec__55224 = cljs.core.first(kw_pairs);
var kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55224,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55224,(1),null);
...
var G__55255 = cljs.core.rest(arglist);
var G__55256 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret_vec,(0),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([curr_arg], 0));
arglist = G__55255;
ret_vec = G__55256;
continue;
} else {
var G__55257 = cljs.core.rest(arglist);
var G__55258 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ret_vec,curr_arg);
arglist = G__55257;
ret_vec = G__55258;
continue;
...
while(true){
var vec__55228 = cljs.core.first(kw_pairs);
var kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55228,(0),null);
var nth_kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55228,(1),null);
...
var G__55260 = remaining;
var G__55261 = kw_pairs;
hiccup = G__55260;
kw_pairs = G__55261;
continue;
} else {
...
var G__55262 = remaining;
var G__55263 = markdown_to_hiccup.core.dec_front(kw_pairs);
hiccup = G__55262;
kw_pairs = G__55263;
continue;
} else {
var G__55264 = remaining;
var G__55265 = kw_pairs;
hiccup = G__55264;
kw_pairs = G__55265;
continue;
}
...
var G__55267 = remaining;
var G__55268 = new_pairs;
hiccup = G__55267;
kw_pairs = G__55268;
continue;
...
var G__55269 = remaining;
var G__55270 = kw_pairs;
hiccup = G__55269;
kw_pairs = G__55270;
continue;
...
/** @this {Function} */
(markdown_to_hiccup.core.hiccup_in.cljs$lang$applyTo = (function (seq55231){
