...
var len__4864__auto___46576 = arguments.length;
var i__4865__auto___46577 = (0);
while(true){
if((i__4865__auto___46577 < len__4864__auto___46576)){
args_arr__4885__auto__.push((arguments[i__4865__auto___46577]));

var G__46578 = (i__4865__auto___46577 + (1));
i__4865__auto___46577 = G__46578;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq46525){
...
var G__46528 = cljs.core.first(seq46525__$2);
var seq46525__$3 = cljs.core.next(seq46525__$2);
var G__46529 = cljs.core.first(seq46525__$3);
var seq46525__$4 = cljs.core.next(seq46525__$3);
var G__46530 = cljs.core.first(seq46525__$4);
var seq46525__$5 = cljs.core.next(seq46525__$4);
var G__46531 = cljs.core.first(seq46525__$5);
var seq46525__$6 = cljs.core.next(seq46525__$5);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46526,G__46527,G__46528,G__46529,G__46530,G__46531,seq46525__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__46552){
var vec__46553 = p__46552;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46553,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46553,(1),null);
