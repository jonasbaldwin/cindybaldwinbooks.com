...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46721 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46721(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_46722 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_46722(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_46723 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_46723(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_46724 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_46724(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46729 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46729(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46730 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46730(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__46719,callback){
var map__46720 = p__46719;
var map__46720__$1 = cljs.core.__destructure_map(map__46720);
var input = map__46720__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46720__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46720__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
