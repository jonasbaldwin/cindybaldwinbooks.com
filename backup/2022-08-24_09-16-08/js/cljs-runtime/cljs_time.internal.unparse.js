...
var periods__$1 = cljs.core.vec((function (){var G__54375 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54373_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__54373_SHARP_,(0),(3));
}),G__54375);
} else {
return G__54375;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__54419){
var vec__54421 = p__54419;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54421,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54421,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__54424 = pattern;
switch (G__54424) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54424)].join('')));
...
switch (G__54439__$1) {
case "millis":
return (function (p1__54428_SHARP_){
return p1__54428_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__54429_SHARP_){
return p1__54429_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__54430_SHARP_){
return p1__54430_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__54431_SHARP_){
return p1__54431_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__54432_SHARP_){
return p1__54432_SHARP_.getHours();
});

break;
case "day":
return (function (p1__54433_SHARP_){
return p1__54433_SHARP_.getDate();
});

break;
case "month":
return (function (p1__54434_SHARP_){
return p1__54434_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__54435_SHARP_){
return p1__54435_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54439__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__54450){
var vec__54453 = p__54450;
...
var key = first__54455;
var args = seq__54454__$1;
var G__54458 = key;
var G__54458__$1 = (((G__54458 instanceof cljs.core.Keyword))?G__54458.fqn:null);
switch (G__54458__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__54461 = (function (){var G__54464 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__54464) : syntax_list.call(null,G__54464));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54461,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54458__$1)].join('')));
...
var d = value;
var G__54471 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__54472 = G__54471;
var seq__54473 = cljs.core.seq(vec__54472);
var first__54474 = cljs.core.first(seq__54473);
var seq__54473__$1 = cljs.core.next(seq__54473);
var unparser = first__54474;
var more = seq__54473__$1;
var s = "";
var d__$1 = d;
var G__54471__$1 = G__54471;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__54486 = G__54471__$1;
var seq__54487 = cljs.core.seq(vec__54486);
var first__54488 = cljs.core.first(seq__54487);
var seq__54487__$1 = cljs.core.next(seq__54487);
var unparser__$1 = first__54488;
var more__$1 = seq__54487__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__54491 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54491,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54491,(1),null);
var G__54619 = d__$3;
var G__54620 = more__$1;
var G__54621 = s__$3;
d__$1 = G__54619;
G__54471__$1 = G__54620;
s__$1 = G__54621;
continue;
}
break;
