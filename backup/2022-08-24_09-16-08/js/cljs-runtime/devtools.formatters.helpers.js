...
var G__42641 = devtools.prefs.pref(v);
v = G__42641;
continue;
} else {
return v;
...
}catch (e42532){var _e__40937__auto__ = e42532;
return false;
}})();
...
}catch (e42537){var _e__40937__auto__ = e42537;
return false;
}})();
...
}catch (e42546){var _e__40937__auto__ = e42546;
return false;
}}
}
});
...
var vec__42590 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__42602_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42602_SHARP_);
}),template);
});
