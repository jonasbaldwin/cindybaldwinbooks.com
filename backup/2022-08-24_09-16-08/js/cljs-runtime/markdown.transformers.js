...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__54890){
var map__54891 = p__54890;
var map__54891__$1 = cljs.core.__destructure_map(map__54891);
var state = map__54891__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54891__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54891__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__54964 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__54965 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__54964;
remaining = G__54965;
continue;
} else {
var G__54967 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__54968 = cljs.core.rest(remaining);
buf = G__54967;
remaining = G__54968;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__54896){
var map__54897 = p__54896;
var map__54897__$1 = cljs.core.__destructure_map(map__54897);
var state = map__54897__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54897__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54897__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54897__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54897__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54897__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__54900){
var map__54901 = p__54900;
var map__54901__$1 = cljs.core.__destructure_map(map__54901);
var state = map__54901__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54901__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54901__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__54903){
var map__54904 = p__54903;
var map__54904__$1 = cljs.core.__destructure_map(map__54904);
var state = map__54904__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54904__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54904__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__54902_SHARP_){
var vec__54905 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__54902_SHARP_,(1),(cljs.core.count(p1__54902_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54905,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54905,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54909)].join('');
} else {
return G__54909;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__54908_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__54908_SHARP_,(1),(cljs.core.count(p1__54908_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__54910){
var map__54911 = p__54910;
var map__54911__$1 = cljs.core.__destructure_map(map__54911);
var state = map__54911__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54911__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__54912){
var map__54913 = p__54912;
var map__54913__$1 = cljs.core.__destructure_map(map__54913);
var state = map__54913__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54913__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__54916){
var map__54917 = p__54916;
var map__54917__$1 = cljs.core.__destructure_map(map__54917);
var state = map__54917__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54917__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54917__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__4251__auto__ = paragraph;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__54918 = next_line;
if((G__54918 == null)){
return null;
} else {
return clojure.string.trim(G__54918);
}
})()));
} else {
return and__4251__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__54922){
var map__54923 = p__54922;
var map__54923__$1 = cljs.core.__destructure_map(map__54923);
var state = map__54923__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54923__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54923__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54923__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54923__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__54924){
var map__54925 = p__54924;
var map__54925__$1 = cljs.core.__destructure_map(map__54925);
var state = map__54925__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54925__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54925__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54925__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54925__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54925__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__54926 = next_line;
if((G__54926 == null)){
return null;
} else {
return clojure.string.trim(G__54926);
}
})()));
...
var vec__54928 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54928,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54928,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__54935){
var map__54936 = p__54935;
var map__54936__$1 = cljs.core.__destructure_map(map__54936);
var state = map__54936__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54936__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54936__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54936__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54936__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__4253__auto__ = code;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__54937){
var map__54938 = p__54937;
var map__54938__$1 = cljs.core.__destructure_map(map__54938);
var state = map__54938__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54938__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54938__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54938__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54938__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return (function (p1__54939_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__54939_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__54940){
var vec__54941 = p__54940;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54941,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54941,(1),null);
...
var vec__54944 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54944,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54944,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54944,(2),null);
var vec__54947 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54947,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54947,(1),null);
...
var vec__54953 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54953,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54953,(1),null);
...
var G__55053 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__55054 = cljs.core.rest(remain);
var G__55055 = key;
acc = G__55053;
remain = G__55054;
prev_key = G__55055;
